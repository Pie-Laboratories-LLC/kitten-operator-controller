...
*/}}
{{- define "kitten-operator-controller.name" -}}
...
*/}}
{{- define "kitten-operator-controller.fullname" -}}
...
*/}}
{{- define "kitten-operator-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "kitten-operator-controller.resourceName" -}}
{{- $fullname := include "kitten-operator-controller.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "kitten-operator-controller.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "kitten-operator-controller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
